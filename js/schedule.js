function Schedule(options) {
    ...
    schedule.init = function(options) {
        ...
        schedule.tabList = [
            { name: 'Friday', displayName: 'Fri', tabDate: new Date(2019,08,16) },
            { name: 'Saturday', displayName: 'Sat', tabDate: new Date(2019,08,17) },
            { name: 'Sunday', displayName: 'Sun', tabDate: new Date(2019,08,18) },
    ...
    schedule.addListControls = function() {
        ...
        var filterForm = '<div id="filter-form">\
                <label for="list-filter">Search names, facilitators, spaces and descriptions:</label>\
